...
**Theological virtues**: Faith, Hope, and Love, with Love defined as *"the final
...
things, water) and a single instruction for a child-proposed risky activity:
...
- **Voice biometrics** for identifying which child is at the tablet, and the
  decision that they are **not** an acceptable account-recovery
