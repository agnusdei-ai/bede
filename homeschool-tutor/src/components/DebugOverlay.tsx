...
import { clearDebugEntries, subscribeDebug, type DebugEntry } from '../hooks/debugBus'
 ...
 * toggled from the chat header's bug icon. Exists because "the recorder
 * isn't doing what I expect" reports have no other way to see WHAT it
 * actually did on a device we can't attach a remote debugger to. See
 * debugBus.ts's logDebug() call sites for what gets recorded.
 */
