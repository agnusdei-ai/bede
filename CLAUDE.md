...
- **Mistral** (`mistral_model`, default `mistral-large-latest`) and **OpenAI**
  ...
  (Mistral primary, OpenAI as the live failover if Mistral errors mid-request).
