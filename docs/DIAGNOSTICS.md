...
- **A browser-driven check that reads this buffer automatically**, and
  the loop that acts on it, are separate changes — see
  `scripts/synthetic_journey.mjs` once it lands.
