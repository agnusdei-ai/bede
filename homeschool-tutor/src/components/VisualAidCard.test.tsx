 ...
 * previously-diagnosed CSP root cause (nginx.conf/site/_headers) was
 * independently confirmed still correctly deployed (site-headers-live.yml
 * green), so the card's own fetch resilience was the remaining gap.
 *
 * What's pinned here:
