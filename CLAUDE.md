...
routers/
  ...
  admin.py           GET /admin/status; GET /admin/audit; GET+POST /admin/license (in-app license view/renew — verified offline, stored in LicenseConfig, effective immediately); GET+POST /admin/ai-provider (in-app AI-provider switch — see "Live AI-provider switching" below)
