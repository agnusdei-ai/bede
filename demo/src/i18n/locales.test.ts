...
// Mirrors homeschool-tutor/src/i18n/locales.test.ts — regression guard for
// silent localization gaps: a key added to en.json and forgotten in es.json
// wouldn't error at runtime, i18next just falls back to the key string
// itself, which a translated deployment would ship without anyone noticing.
