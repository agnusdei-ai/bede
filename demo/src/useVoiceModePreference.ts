...
/**
 * MIRRORED from homeschool-tutor/src/hooks/useVoiceModePreference.ts, same
 * reasoning as demo/src/endpointing.ts and demo/src/holdGesture.ts: the demo
 * must not have worse voice behaviour than the product it is selling.
 *
 ...
 * and was removed for exactly that reason (see App.tsx's own
 ...
 * actually finishing), not a timer — see App.tsx's continuous-mode
