...
| Know what principles govern security design decisions | [docs/ARCHITECTURE_PRINCIPLES.md](docs/ARCHITECTURE_PRINCIPLES.md) — sixteen principles on the eight CISSP domains, cross-mapped to AIUC-1, NIST AI RMF, ISO/IEC 42001, OWASP LLM/Agentic Top 10, and MITRE ATLAS, each with a conformance status |
