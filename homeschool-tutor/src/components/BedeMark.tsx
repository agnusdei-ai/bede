...
export function AgnusDeiMark({ className = 'w-10 h-10' }: { className?: string }) {
  return <img src="/agnus-dei-emblem.webp" alt="Agnus Dei Technologies" className={className} />
}

export function AgnusDeiLogo({ className = 'h-8' }: { className?: string }) {
  return <img src="/agnus-dei-logo.webp" alt="Agnus Dei Technologies" className={className} />
}
