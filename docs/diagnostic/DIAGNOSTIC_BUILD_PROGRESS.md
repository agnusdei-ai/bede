...
| 2 — Persistence | in progress (2/3 units) | V-only persistence (no θ/C) — user-approved design |
| 3 — Loop integration | not started | — |
| 4 — Parent surface | not started | — |
| 5 — Validation & tuning | not started | — |

**Current status:** Unit 2.2 (`process_evidence` real DB round trip) merged. Next: unit 2.3 (Pydantic schemas), the last Phase 2 unit before the Phase 2→3 gate.
