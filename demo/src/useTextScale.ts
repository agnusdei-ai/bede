...
/**
 * Site-wide text-size preference, persisted directly to localStorage.
 *
 * Implemented as a root <html> font-size percentage: every Tailwind
 * fontSize utility here is rem-based (see tailwind.config.js's own
...
const STORAGE_KEY = 'bede-demo-text-scale'
